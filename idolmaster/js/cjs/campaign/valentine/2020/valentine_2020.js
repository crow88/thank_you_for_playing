...
p.nominalBounds = new cjs.Rectangle(0,0,460,174);// helper functions:
...
(lib.text_field_white = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{line4:0,line3:1,line2:2,line1:3});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.m1,p:{y:2}},{t:this.m2,p:{y:18}},{t:this.m3,p:{y:34}},{t:this.m4,p:{y:49}}]}).to({state:[{t:this.m2,p:{y:9}},{t:this.m3,p:{y:25}},{t:this.m4,p:{y:41}}]},1).to({state:[{t:this.m1,p:{y:17}},{t:this.m2,p:{y:33}},{t:this.m3,p:{y:49}},{t:this.m4,p:{y:64}}]},1).to({state:[{t:this.m1,p:{y:25}},{t:this.m2,p:{y:41}},{t:this.m3,p:{y:57}},{t:this.m4,p:{y:72}}]},1).wait(1));
...
(lib.text_field_cute = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.m1,p:{y:2,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m2,p:{y:18,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m3,p:{y:34,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m4,p:{y:49,font:"12px 'Arial'",lineHeight:15.35}}]}).to({state:[{t:this.m2,p:{y:9,font:"12px 'MS PGothic'",lineHeight:14}},{t:this.m3,p:{y:25,font:"12px 'MS PGothic'",lineHeight:14}},{t:this.m4,p:{y:41,font:"12px 'MS PGothic'",lineHeight:14}}]},1).to({state:[{t:this.m1,p:{y:17,font:"12px 'MS PGothic'",lineHeight:14}},{t:this.m2,p:{y:33,font:"12px 'MS PGothic'",lineHeight:14}},{t:this.m3,p:{y:49,font:"12px 'MS PGothic'",lineHeight:14}},{t:this.m4,p:{y:64,font:"12px 'MS PGothic'",lineHeight:14}}]},1).to({state:[{t:this.m1,p:{y:25,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m2,p:{y:41,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m3,p:{y:57,font:"12px 'Arial'",lineHeight:15.35}},{t:this.m4,p:{y:72,font:"12px 'Arial'",lineHeight:15.35}}]},1).wait(1));
...
(lib.cursor_inner = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{black:0,white:1,cute:2,cool:3,passion:4});
...
(lib.text_fields = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"white":0,"black":10,"cute":20,"cool":29,"passion":38,cute_ex1:47,cool_ex1:56,passion_ex1:65});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.tf}]}).to({state:[{t:this.tf_1}]},10).to({state:[{t:this.tf_2}]},10).to({state:[{t:this.tf_3}]},9).to({state:[{t:this.tf_4}]},9).to({state:[{t:this.m1,p:{color:"#FF60AF"}},{t:this.m2,p:{color:"#FF60AF"}},{t:this.m3,p:{color:"#FF60AF"}},{t:this.m4,p:{color:"#FF60AF"}},{t:this.m5,p:{color:"#FF60AF"}}]},9).to({state:[{t:this.m1,p:{color:"#0085F2"}},{t:this.m2,p:{color:"#0085F2"}},{t:this.m3,p:{color:"#0085F2"}},{t:this.m4,p:{color:"#0085F2"}},{t:this.m5,p:{color:"#0085F2"}}]},9).to({state:[{t:this.m1,p:{color:"#FF912D"}},{t:this.m2,p:{color:"#FF912D"}},{t:this.m3,p:{color:"#FF912D"}},{t:this.m4,p:{color:"#FF912D"}},{t:this.m5,p:{color:"#FF912D"}}]},9).wait(9));
...
(lib.text_base_unique2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleY:0.7719},0).wait(1).to({scaleY:0.5575},0).wait(1).to({scaleY:0.3573},0).wait(1));
...
(lib.sprite66b = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:2.802,scaleY:2.7395,rotation:-48.2594,x:77,y:-98.5},7,cjs.Ease.quadOut).wait(1).to({scaleY:2.7394,rotation:-59.9604,x:81.1,y:-101.65,alpha:0.4297},0).to({_off:true},1).wait(2));
...
(lib.pusher_next = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},5).wait(1).to({regX:0.7,regY:1.3,x:0.7,y:1.3,alpha:0.9931},0).wait(1).to({alpha:0.9722},0).wait(1).to({alpha:0.9375},0).wait(1).to({alpha:0.8889},0).wait(1).to({alpha:0.8264},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.6597},0).wait(1).to({alpha:0.5556},0).wait(1).to({alpha:0.4375},0).wait(1).to({alpha:0.3056},0).wait(1).to({alpha:0.1597},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0},0).wait(1).to({regX:0.7,regY:1.3,x:0.7,y:1.3,alpha:0.0204},0).wait(1).to({alpha:0.0816},0).wait(1).to({alpha:0.1837},0).wait(1).to({alpha:0.3265},0).wait(1).to({alpha:0.5102},0).wait(1).to({alpha:0.7347},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:1},0).wait(1));
...
(lib.efa_hana2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({skewX:-159.4226,skewY:20.5774,guide:{path:[5.7,-1.5,100.8,-42.2,3.9,-107.3], orient:'auto'},alpha:0},17,cjs.Ease.get(0.91)).wait(1));
...
(lib.cursor = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.inner).wait(1).to({regY:0,y:-1.1959},0).wait(1).to({y:-0.0076},0).wait(1).to({y:1.365},0).wait(1).to({regY:-0.6,y:1.65},0).wait(1).to({regY:0,y:1.4459},0).wait(1).to({y:0.2576},0).wait(1).to({y:-1.115},0).wait(1).to({regY:-0.6,y:-1.6},0).wait(1));
...
(lib.cursol_container = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cu).wait(1).to({y:-1.3},0).wait(1).to({y:-8.3},0).wait(1).to({y:-15.3},0).wait(1));
...
(lib.unit = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{nod:9,swing:18,jump_flower:36,nod2:48});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(36).to({_off:false},0).to({_off:true},11).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({y:131},4).to({y:125},4).wait(1).to({regX:131,regY:251,x:131,y:251},0).wait(1).to({regX:130,regY:125.5,rotation:-0.0818,x:129.85,y:125.45},0).wait(1).to({rotation:-0.3088,x:129.35,y:125.5},0).wait(1).to({rotation:-0.6412,x:128.6},0).wait(1).to({rotation:-1.0257,x:127.8},0).wait(1).to({rotation:-1.4031,x:126.9},0).wait(1).to({rotation:-1.718,x:126.25,y:125.55},0).wait(1).to({rotation:-1.9264,x:125.8,y:125.6},0).wait(1).to({regX:130.9,regY:251,rotation:-1.9999,x:130.9,y:251},0).wait(1).to({regX:130,regY:125.5,rotation:-1.9349,x:125.85,y:125.55},0).wait(1).to({rotation:-1.7523,x:126.25},0).wait(1).to({rotation:-1.4781,x:126.85,y:125.5},0).wait(1).to({rotation:-1.1477,x:127.5,y:125.55},0).wait(1).to({rotation:-0.802,x:128.3,y:125.5},0).wait(1).to({rotation:-0.4824,x:129},0).wait(1).to({rotation:-0.2251,x:129.6},0).wait(1).to({rotation:-0.0582,x:129.95,y:125.45},0).wait(1).to({regX:131,regY:251,rotation:0,x:131,y:251},0).wait(1).to({y:257},0).wait(1).to({regX:130,regY:125.5,x:130,y:116.5},0).wait(1).to({regX:131,regY:251,x:131,y:237},0).wait(1).to({regX:130,regY:125.5,x:130,y:112.55},0).wait(1).to({y:116.15},0).wait(1).to({regX:131,regY:251,x:131,y:254},0).wait(1).to({regX:130,regY:125.5,x:130,y:128.05},0).wait(1).to({y:126.7},0).wait(1).to({regX:131,regY:251,x:131,y:250},0).wait(1).to({regX:130,regY:125.5,x:130,y:125.1},0).wait(1).to({y:125.4},0).wait(1).to({regX:131,regY:251,x:131,y:251},0).wait(2).to({regX:130,regY:125.5,x:130,y:125.65},0).wait(1).to({y:126.2},0).wait(1).to({y:127.3},0).wait(1).to({y:128.65},0).wait(1).to({y:129.75},0).wait(1).to({y:130.3},0).wait(1).to({regX:131,regY:251,x:131,y:256},0).wait(1).to({regX:130,regY:125.5,x:130,y:130.3},0).wait(1).to({y:129.75},0).wait(1).to({y:128.65},0).wait(1).to({y:127.3},0).wait(1).to({y:126.2},0).wait(1).to({y:125.65},0).wait(1).to({regX:131,regY:251,x:131,y:251},0).wait(1));
...
(lib.yajirusi = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{dark_gray:0,"white":10,"cute":18,"cool":23,"passion":29,"cute_ex1":37,"cool_ex1":42,"passion_ex1":48});
	...
	this.timeline.addTween(cjs.Tween.get(this.ar1).wait(10).to({regX:6.3,regY:5.5,x:-6.65,y:-6.45},0).wait(27).to({x:-19.7,y:-13.5},0).wait(19));
...
(lib.text_window = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"white":0,"black":10,transparent:20,blue:30,red:40,unique1:52});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(52).to({_off:false},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.b1).wait(40).to({_off:false},0).to({_off:true},12).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.b1_1).wait(30).to({_off:false},0).to({_off:true},10).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.b1_2).wait(20).to({_off:false},0).to({_off:true},10).wait(34));
	...
	this.timeline.addTween(cjs.Tween.get(this.b1_3).wait(10).to({_off:false},0).to({_off:true},10).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.b1_4).to({_off:true},10).wait(54));
...
(lib.sprite43 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.7356,scaleY:0.7356},1).to({scaleX:1.4901,scaleY:1.4901},1).to({scaleX:2.1305,scaleY:2.1305,rotation:-34.3349,alpha:0.5},4).wait(1));
...
(lib.common_message_window = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{standby:1,in1:9,out1:14,in2:19,out2:24,in3:29,out3:37,text_change:44,blank:51});
	...
	this.timeline.addTween(cjs.Tween.get(this.ar).wait(1).to({alpha:1},0).wait(8).to({alpha:0.0117},0).wait(2).to({alpha:1},0).wait(3).to({alpha:0.0117},0).wait(7).to({alpha:1},0).wait(3).to({alpha:0.0117},0).wait(8).to({alpha:1},0).wait(5).to({alpha:0.0117},0).wait(9).to({alpha:1},0).wait(5).to({alpha:0.0117},0).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.t).wait(1).to({y:38.9,alpha:1},0).wait(8).to({y:188.9,alpha:0.0117},0).wait(2).to({y:38.9,alpha:1},0).wait(4).to({y:188.9,alpha:0.0117},0).wait(6).to({y:38.9,alpha:1},0).wait(4).to({y:188.9,alpha:0.0117},0).wait(4).to({y:108.9,alpha:1},0).wait(1).to({y:97.9},0).wait(1).to({y:57.9},0).wait(1).to({y:38.9},0).wait(1).to({regX:138.3,regY:33.9,x:144.3,y:31.9},0).wait(1).to({regX:131.8,regY:37.9,x:137.8,y:34.9},0).wait(1).to({regX:138.3,regY:33.9,x:144.3,y:31.9},0).wait(1).to({regX:131.8,regY:37.9,x:137.8,y:38.9},0).wait(2).to({regX:138.3,regY:33.9,x:144.3,y:39.5},0).wait(1).to({y:57.1},0).wait(1).to({y:84.65},0).wait(1).to({y:102.25},0).wait(1).to({regX:131.8,regY:37.9,x:137.8,y:110.9},0).wait(1).to({y:38.9},0).wait(8).to({y:188.9,alpha:0.0117},0).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.b).wait(1).to({alpha:1},0).wait(8).to({scaleY:0.1},0).wait(1).to({regY:38,scaleY:0.6222,y:54.65},0).wait(1).to({scaleY:0.9355,y:66.55},0).wait(1).to({regY:0,scaleY:1.04,y:31},0).wait(1).to({scaleY:1},0).wait(1).to({scaleY:1.04},0).wait(1).to({regY:38,scaleY:0.5178,y:50.65},0).wait(1).to({scaleY:0.2044,y:38.75},0).wait(1).to({regY:0,scaleY:0.1,y:31},0).wait(1).to({scaleY:1,alpha:0.0117},0).wait(2).to({regY:38,y:69,alpha:0.5608},0).wait(1).to({alpha:0.8902},0).wait(1).to({regY:0,y:31,alpha:1},0).wait(3).to({regY:38,y:69,alpha:0.451},0).wait(1).to({alpha:0.1215},0).wait(1).to({regY:0,y:31,alpha:0.0117},0).wait(2).to({y:101,alpha:1},0).wait(1).to({y:90},0).wait(1).to({y:50},0).wait(1).to({y:31},0).wait(1).to({regY:38,y:65.95},0).wait(1).to({regY:0,y:27},0).wait(1).to({regY:38,y:65.95},0).wait(1).to({regY:0,y:31},0).wait(2).to({regY:38,y:73.6},0).wait(1).to({y:91.2},0).wait(1).to({y:118.75},0).wait(1).to({y:136.35},0).wait(1).to({regY:0,y:103},0).wait(1).to({y:100.1,alpha:0.0117},0).wait(1).to({y:31,alpha:1},0).wait(1).to({scaleY:0.925},0).wait(1).to({scaleY:1.2002},0).to({scaleY:1},3).wait(2).to({alpha:0.0117},0).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.b_guide).to({_off:true},1).wait(56));
...
(lib.window_container = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{center:1,align_bottom_line3:14,align_bottom_line2:29,align_bottom_line1:44,align_top_line3:59,align_top_line2:74,align_top_line1:89,"unique1":101});
	...
	this.timeline.addTween(cjs.Tween.get(this.window).wait(14).to({y:87.9},0).wait(15).to({y:95.4},0).wait(15).to({y:102.9},0).wait(15).to({y:72.9},0).wait(15).to({y:65.4},0).wait(15).to({y:57.9},0).wait(12).to({y:72.9},0).wait(9));
...
(lib.sprite442 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1}]},2).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(7).to({_off:false},0).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(8).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(12).to({_off:false},0).wait(1));
...
(lib.sprite44_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance}]},3).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).wait(5));
...
(lib.valentine_2020 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"プレゼントもらう＆テキスト":27,台詞2:77,scene1:1,scene2_a:9,scene3:27,scene4:77,scene5:100,scene2_b:125,label_se1:27,label_se2:60,label_se3:87});
	...
	this.frame_0 = function() {
		...
		*/
		...
		exportRoot._url = window.im_cjs._url || "http://www.mbga.jp";//遷移先
	...
	this.frame_39 = function() {
		//gotoAndPlay("window_1/window/:out1");
	}
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(79).to({_off:false},0).wait(1).to({regX:142.1,regY:59.9,x:142.1,y:357.9},0).wait(1).to({y:350.2},0).wait(1).to({y:335.1},0).wait(1).to({y:313.75},0).wait(1).to({y:293.75},0).wait(1).to({y:280.55},0).wait(1).to({y:273.95},0).wait(1).to({regX:120,regY:47,x:120,y:259.2},0).to({y:263.2},3,cjs.Ease.get(1)).wait(10).to({alpha:0},2).to({_off:true},1).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:0.1016},5).to({_off:true},1).wait(3).to({_off:false},0).to({alpha:1},4).to({alpha:0.1016},7).to({_off:true},1).wait(104).to({_off:false},0).to({alpha:1},4).to({alpha:0.1016},3).to({_off:true},1).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.place).wait(9).to({alpha:0.0117},4).to({_off:true},1).wait(111).to({_off:false,alpha:1},0).to({alpha:0},4).to({_off:true},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(13).to({_off:false},0).wait(1).to({regX:142.1,regY:59.9,x:142.1,y:357.9},0).wait(1).to({y:350.2},0).wait(1).to({y:335.1},0).wait(1).to({y:313.75},0).wait(1).to({y:293.75},0).wait(1).to({y:280.55},0).wait(1).to({y:273.95},0).wait(1).to({regX:120,regY:47,x:120,y:259.2},0).to({y:263.2},3,cjs.Ease.get(1)).wait(15).to({y:263},0).to({y:261},2,cjs.Ease.get(1)).wait(1).to({regX:142.1,regY:59.9,x:142.1,y:279.2},0).wait(1).to({y:299.4},0).wait(1).to({y:332.85},0).wait(1).to({y:355.75},0).wait(1).to({regX:120,regY:47,x:120,y:349},0).to({_off:true},1).wait(82).to({_off:false,y:347.2},0).wait(1).to({regX:142.1,regY:59.9,x:142.1,y:357.9},0).wait(1).to({y:350.2},0).wait(1).to({y:335.1},0).wait(1).to({y:313.75},0).wait(1).to({y:293.75},0).wait(1).to({y:280.55},0).wait(1).to({y:273.95},0).wait(1).to({regX:120,regY:47,x:120,y:259.2},0).to({y:263.2},3,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(60).to({_off:false},0).to({y:198.75},3,cjs.Ease.get(1)).to({_off:true},62).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(60).to({_off:false},0).to({_off:true},65).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60).to({_off:false},0).wait(41).to({regX:14.2,regY:-4.5,x:118.45,y:224.05,alpha:0.9615},0).wait(1).to({alpha:0.9074},0).wait(1).to({alpha:0.8389},0).wait(1).to({alpha:0.7579},0).wait(1).to({alpha:0.6667},0).wait(1).to({alpha:0.5682},0).wait(1).to({alpha:0.466},0).wait(1).to({alpha:0.364},0).wait(1).to({alpha:0.2665},0).wait(1).to({alpha:0.1776},0).wait(1).to({alpha:0.1013},0).wait(1).to({alpha:0.0411},0).wait(1).to({regX:0,regY:0,x:106,y:228,alpha:0},0).to({_off:true},1).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(60).to({_off:false},0).to({_off:true},17).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(55).to({_off:false},0).wait(1).to({regX:-2,regY:-14,scaleX:0.7931,scaleY:0.793,rotation:2.9295,x:122.7,y:119.7},0).wait(1).to({scaleX:0.8087,scaleY:0.8086,rotation:2.708,x:122.05,y:128.3},0).wait(1).to({scaleX:0.8374,scaleY:0.8373,rotation:2.3024,x:120.65,y:144.05},0).wait(1).to({scaleX:0.8874,scaleY:0.8873,rotation:1.5949,x:118.35,y:171.45},0).wait(1).to({regX:0,regY:0.4,scaleX:1,scaleY:1,rotation:0,x:115,y:247.35},0).to({y:252.35},3,cjs.Ease.get(1)).to({regY:-0.1,y:245.85},3,cjs.Ease.get(-0.49)).to({regY:0.4,y:247.35},3,cjs.Ease.get(0.28)).wait(32).to({regX:-2,regY:-14,scaleX:1.0098,scaleY:1.0098,x:113,y:233.45,alpha:0.9619},0).wait(1).to({scaleX:1.0235,scaleY:1.0235,x:112.95,y:234.25,alpha:0.9085},0).wait(1).to({scaleX:1.0409,scaleY:1.0409,x:112.9,y:235.3,alpha:0.8408},0).wait(1).to({scaleX:1.0615,scaleY:1.0615,y:236.45,alpha:0.7607},0).wait(1).to({scaleX:1.0847,scaleY:1.0847,x:112.85,y:237.75,alpha:0.6706},0).wait(1).to({scaleX:1.1097,scaleY:1.1097,x:112.8,y:239.15,alpha:0.5732},0).wait(1).to({scaleX:1.1357,scaleY:1.1357,x:112.75,y:240.65,alpha:0.4723},0).wait(1).to({scaleX:1.1616,scaleY:1.1616,x:112.7,y:242.15,alpha:0.3715},0).wait(1).to({scaleX:1.1864,scaleY:1.1864,x:112.65,y:243.55,alpha:0.2751},0).wait(1).to({scaleX:1.209,scaleY:1.209,x:112.6,y:244.8,alpha:0.1872},0).wait(1).to({scaleX:1.2284,scaleY:1.2284,x:112.55,y:245.95,alpha:0.1118},0).wait(1).to({scaleX:1.2437,scaleY:1.2437,x:112.5,y:246.85,alpha:0.0523},0).wait(1).to({regX:0,regY:0,scaleX:1.2541,scaleY:1.2541,x:115,y:265.5,alpha:0.0117},0).to({_off:true},1).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(57).to({_off:false},0).to({alpha:0.6406},3,cjs.Ease.get(-1)).to({_off:true},1).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(55).to({_off:false},0).wait(1).to({regY:-74.4,y:135,alpha:0.0888},0).wait(1).to({y:132.3,alpha:0.2027},0).wait(1).to({y:127.9,alpha:0.3925},0).wait(1).to({y:121.65,alpha:0.6583},0).wait(1).to({regY:0,y:188.1,alpha:1},0).wait(1).to({regY:-74.4,y:119.2},0).wait(1).to({y:123.15},0).wait(1).to({y:125.5},0).wait(1).to({regY:0,y:200.7},0).wait(1).to({regY:-74.4,y:124.05},0).wait(1).to({regY:0,y:197.7},0).wait(1).to({regY:-74.4,y:123.3},0).wait(1).to({y:123.4},0).wait(1).to({y:123.45},0).wait(1).to({regY:0,y:197.95},0).wait(1).to({regY:-74.4,y:123.55},0).wait(4).to({regY:0,y:197.95},0).to({_off:true},50).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(13).to({_off:false},0).wait(48).to({y:355.2},0).to({_off:true},64).wait(4).to({_off:false,y:325.2},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(3).to({_off:false},0).to({_off:true},9).wait(113).to({_off:false},0).to({_off:true},3).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]},31).to({state:[]},8).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},30).to({state:[]},9).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_21},{t:this.instance_20},{t:this.instance_19}]},28).to({state:[]},11).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(28).to({_off:false},0).to({scaleX:0.5859,scaleY:0.5859,rotation:-3.7796,y:240.8},3,cjs.Ease.get(-1)).to({scaleX:0.586,scaleY:0.586,rotation:-1.4383,y:199.4},2).to({rotation:3.0463,y:213.65},6,cjs.Ease.get(1)).wait(5).to({rotation:3.0463},0).to({x:133.3,y:229.65},4,cjs.Ease.get(1)).to({scaleX:0.7879,scaleY:0.7878,rotation:3.0034,x:124,y:128},6,cjs.Ease.get(1)).to({_off:true},1).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(13).to({_off:false},0).wait(16).to({regX:125.7,regY:121.5,x:115.7,y:133.65},0).wait(1).to({y:134.35},0).wait(1).to({y:135.6},0).wait(1).to({y:136.75},0).wait(1).to({y:137.3},0).wait(1).to({regX:130,regY:125,x:120,y:141},0).wait(14).to({y:130},2,cjs.Ease.get(1)).to({y:140},4,cjs.Ease.get(-1)).to({y:137},3,cjs.Ease.get(1)).wait(12).to({_off:true},56).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(129).to({_off:false},0).wait(1).to({regX:125.7,regY:121.5,x:134.8,y:133.5,alpha:0.04},0).wait(1).to({x:132,alpha:0.1663},0).wait(1).to({x:127.5,alpha:0.3724},0).wait(1).to({x:122.2,alpha:0.6153},0).wait(1).to({x:117.55,alpha:0.8266},0).wait(1).to({x:114.65,alpha:0.9581},0).wait(1).to({regX:130,regY:125,x:118,y:137,alpha:1},0).to({x:120},4,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(61).to({alpha:1},0).to({alpha:0.6992},8,cjs.Ease.get(1)).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(61).to({_off:false},0).to({alpha:0.0117},8,cjs.Ease.get(1)).to({_off:true},1).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({_off:true},1).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).to({_off:true},1).wait(140));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/cover_sar.png?1581047941384", id:"valentine_2020_cover_sar"},
		{src:"images/fp_hana3.png?1581047941384", id:"valentine_2020_fp_hana3"},
		{src:"images/heart.png?1581047941384", id:"valentine_2020_heart"},
		{src:"images/img_kira.png?1581047941384", id:"valentine_2020_img_kira"},
		{src:"images/replace_target_240x310_bg.jpg?1581047941384", id:"valentine_2020_replace_target_240x310_bg"},
		{src:"images/replace_target_480x502_character.png?1581047941384", id:"valentine_2020_replace_target_480x502_character"},
		{src:"images/Valentine2020.png?1581047941384", id:"valentine_2020_Valentine2020"},
		{src:"images/window.png?1581047941384", id:"valentine_2020_window"},
		{src:"images/window_3.png?1581047941384", id:"valentine_2020_window_3"},
		{src:"images/window_4.png?1581047941384", id:"valentine_2020_window_4"}
	],
	preloads: []
};
