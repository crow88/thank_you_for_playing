...
(lib.reflect_mask_26 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,204,255,0.502)").s().p("");
	this.shape.setTransform(-0.0078,0.0222);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask_26, new cjs.Rectangle(-125.6,-161.9,251.3,323.9), null);
...
(lib.reflect = function(mode,startPosition,loop) {
	...
	this.lighter_tgt.setTransform(0,-221.7,0.8914,0.8914,0,0,-20.001);
	this.lighter_tgt.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-313.1,251.3,626.3), null);
...
(lib.reflect_container_cjs_26 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.5,475.25,1,1,0,0,0,-0.5,0.1);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regY:-0.1,y:-0.1},9,cjs.Ease.get(-1)).to({regY:0.1,y:-475},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-788.2,251.3,1576.5);
...
(lib.reflect_wrapper_26 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper_26, new cjs.Rectangle(0,-313.1,251.3,626.3), null);
...
(lib.sign_effect_26 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.parent = this;
	this.instance.setTransform(229.8,395.05);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(201.65,555.55);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.parent = this;
	this.instance_3.setTransform(23.8,446.7,0.7247,0.7247);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.parent = this;
	this.instance_4.setTransform(119.2,616.65,0.6923,0.6923);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.parent = this;
	this.instance_5.setTransform(92.35,488.25,0.6599,0.6599);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.parent = this;
	this.instance_6.setTransform(162.45,469.15);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.parent = this;
	this.instance_7.setTransform(129.55,364.8);
	...
	this.reflect_mask.setTransform(139.65,524);
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(132.6422,343);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect_26, new cjs.Rectangle(-16.8,162.1,348.8,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// sign
	this.sign_effect = new lib.sign_effect_26();
...
}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(-16.8,0,656.8,837.2), null);


// stage content:
(lib._26_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// replace
	this.instance = new lib.replace();
	this.instance.parent = this;
	this.instance.setTransform(147.5,418.6,1,1,0,0,0,147.5,418.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(303.2,610.9,8.699999999999989,226.30000000000007);
// library properties:
lib.properties = {
	id: '_26_sign_effect',
	width: 640,
...
an.compositions['_26_sign_effect'] = {
