...
(lib.effect_set_base = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{stay:1,heart:3,powapowa:51,heart2:99});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(2).call(this.frame_2).wait(35).call(this.frame_37).wait(13).call(this.frame_50).wait(35).call(this.frame_85).wait(13).call(this.frame_98).wait(26).call(this.frame_124).wait(13).call(this.frame_137).wait(1));

	// heart
	this.instance = new lib.エフェクト_レベルアップ("synched",2,false);
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.4977,1.4977,23.8569);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({startPosition:5},3,cjs.Ease.get(1)).to({_off:true},29).wait(55).to({_off:false,startPosition:2},0).to({startPosition:5},3,cjs.Ease.get(1)).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},0).to({alpha:0},9).to({_off:true},1).wait(77).to({_off:false,alpha:0.6016},0).to({alpha:0},9).to({_off:true},1).wait(22));

	// particle
	this.instance_2 = new lib.efa_パーティクル集合();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,0,0.8734,0.8734);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).to({_off:true},32).wait(55).to({_off:false},0).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(19).to({_off:false},0).wait(1).to({alpha:1},30).to({_off:true},1).wait(16).to({_off:false,alpha:0},0).wait(1).to({alpha:1},30).to({_off:true},1).wait(7).to({_off:false,alpha:0},0).wait(1).to({alpha:1},30).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(19).to({_off:false},0).wait(1).to({alpha:0.4492},30).to({_off:true},1).wait(16).to({_off:false,alpha:0},0).wait(1).to({alpha:0.4492},30).to({_off:true},1).wait(7).to({_off:false,alpha:0},0).wait(1).to({alpha:0.4492},30).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.grip).to({_off:true},1).wait(137));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/petit_effect_atlas_.png?1613976907109", id:"petit_effect_atlas_"}
	],
	preloads: []
};
