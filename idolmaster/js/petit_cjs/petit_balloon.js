...
lib.ssMetadata = [
		{name:"petit_balloon_atlas_", frames: [[0,0,624,180],[626,0,72,140],[610,182,72,140],[610,324,72,80],[732,122,72,60],[684,264,72,60],[0,182,608,168],[700,0,46,120],[684,142,46,120],[732,184,46,60],[748,0,46,40],[748,42,46,40]]}
];
...
(lib.mc_fkds_set = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.core).wait(1).to({scaleX:0.5,scaleY:0.2,y:56},0).to({scaleX:1.02,scaleY:1.02,y:-2},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,y:0},2).wait(6).to({scaleX:0.5,scaleY:0.2,y:-56},0).to({scaleX:1.02,scaleY:1.02,y:2},3,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,y:0},2).wait(4));
...
(lib.petit_balloon = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		//
		///**
		//small_character_flg = 0;//0:ノーマル, 1:小さい子
		//big_character_flg = 0;//0:ノーマル, 1:きらり
		//cheek_type = 2;//肌色のタイプ 1:ふつう 2:褐色
		//
		//
		//chara_num = 5;//話している人数 : 1~10人
		//chara_order = 5;//左から数えて何番目の位置
		//
		//init_motion="in_walk";
		//
		//
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/petit_balloon_atlas_.png?1612780042444", id:"petit_balloon_atlas_"}
	],
	preloads: []
};
