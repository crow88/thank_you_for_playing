...
$(function() {
    ...
    function t(e) {
        var e, t;
        e = "l_premium" == m.detail_list[c].show_card_type ? +m.detail_list[c].archive.normal ? m.images.l[c] : m.images.l_premium[c] : +m.detail_list[c].archive.premium ? m.images.l_premium[c] : +m.detail_list[c].archive.normal ? m.images.l[c] : "", t = "l_premium" == m.detail_list[c].show_card_type ? m.images.l_nosign[c] : +m.detail_list[c].archive.premium ? m.images.l_nosign_p[c] : +m.detail_list[c].archive.normal ? m.images.l_nosign[c] : "", q.set({
    ...
    function a() {
        m.detail_list[c].filtered_comments = r(m.detail_list[c].comments), m.detail_list[c].voice_enable = Y.check.isVoicePlay(), A.set(m.detail_list[c]), P.render()
    }
    ...
    function n() {
        ...
        if (e.voice_enable) {
            var t = e.data.attribute.slice(0, 2),
                ...
                a = [];
            $(".btn_idol_voice").each(function(n, l) {
                var r = $(l).data("voice-key"),
                    _ = e.voice[r];
                _ && a.push({
                    id: r + "_" + i,
                    path: _,
    ...
    function l() {
        Object.keys(m.idol_story_list).length > 0 && (K.set({
            idol_story_list: m.idol_story_list,
            idol_detail: m.detail_list[c],
            ios_app_flg: m.ios_app_flg,
            apple_review: m.apple_review,
            paging_info: Q.get_paging_info(m.idol_story_list)
        }), Q.render())
    }
    ...
    var d = window.birthday_flag,
        ...
        B = {};
    B[g + " .js_btn_expansion"] = "show_expansion_popup", B[g + " .js_btn_change_card_type"] = "change_card_type";
    var T = Backbone.View.extend({
            ...
            show_expansion_popup: function() {
                ...
                a.hide(), n.hide(), "l_premium" == m.detail_list[c].show_card_type && x || +m.detail_list[c].archive.normal && !+m.detail_list[c].archive.premium && x ? (i.find(".mask01").remove(), Commonjs.replacePremiumCard({
                    replace_element: o,
                    ...
                    function e(e) {
                        ...
                        if (-1 != a.search(/iPhone/)) var o = 5;
                        else var o = 2;
                        (t = Math.floor(n.x * o)) > 1 | t < -1 && (-1 != a.search(/iPhone/) ? i.find(".cardFrame02").css("background-position-x", 30 * -t + "px") : i.find(".cardFrame02").css("background-position-x", 80 * t + "px"))
                    }
                    ...
                    if (window.addEventListener("devicemotion", e, !0), window.addEventListener("MozOrientation", e, !0), window.localStorage) {
                        2 == localStorage.getItem("CardEffectSet") && (i.find(".cardFrame01").hide(), i.find(".cardFrame02").hide())
                    }
    ...
    var N = Backbone.View.extend({
            ...
            prepare: function() {},
            render: function() {
                this.$el.html(this.template(this.model.toJSON())), Commonjs.setAccordion()
            }
        }),
        A = new J,
        P = new N({
        ...
        D = {};
    D[g + " .checkForm"] = "set_voice_image", D[g + " .btn_pager_first"] = "pager_first", D[g + " .btn_pager_back"] = "pager_back", D[g + " .btn_pager_next"] = "pager_next", D[g + " .btn_pager_last"] = "pager_last";
    var H = Backbone.View.extend({
            ...
            set_voice_image: function(e) {
                var t = $(e.currentTarget),
                    ...
                    n = i.find(".movie_name");
                if (1 == a.val()) {
                    a.val("0"), t.removeClass("ep_on").addClass("ep_off");
                    for (var o = 0; o < n.length; o++) n.eq(o).attr("src", n.eq(o).attr("src").replace("_voice", ""))
                } else {
                    a.val("1"), t.removeClass("ep_off").addClass("ep_on");
                    for (var o = 0; o < n.length; o++) n.eq(o).attr("src", n.eq(o).attr("src").replace(".png", "_voice.png"))
                }
            },
            get_paging_info: function(e) {
                return this.paging_info = {
                    contents_num: 3,
                    current_page: 0,
                    max_page_num: Math.floor((Object.keys(e).length - 1) / 3)
                }, this.paging_info
            },
    ...
    $(window).on("load", function() {
        S.set(), M.render(), $("#contents_tab").tab_switch({
            tabs: "[name^='tab_']",
            contents: "[class^='area_tab_']",
            start: w
        }), t(), i(), a(), n(), l(), null != y && $("#comment-content").find(".selectArea_accordion_title").eq(y).trigger(g, !1), Object.keys(m.idol_story_list).length > 0 && (K.set({
            idol_story_list: m.idol_story_list,
            idol_detail: m.detail_list[c],
            ios_app_flg: m.ios_app_flg,
            apple_review: m.apple_review
        }), Q.render()), W.set(m.detail_list[c]), X.render(), e(), $(".idolList").iSlider({
            height: "160px",
            slideshowSpeed: 0,
            navi: ".icon_navi",
            ...
            c = $(o.currentTarget).data("index"), m.detail_list[c].show_card_type = "l", t(), i(), a(), n(), l(), W.set(m.detail_list[c]), X.render(), e()
        })
    });
    var Y = Y || {
        check: {
