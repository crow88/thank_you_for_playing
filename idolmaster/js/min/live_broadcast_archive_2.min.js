...
! function(e) {
    ...
    var __WEBPACK_IMPORTED_MODULE_0__lib_user_message__ = __webpack_require__(1),
        __WEBPACK_IMPORTED_MODULE_1__lib_idol_message_2__ = __webpack_require__(2),
        ...
        LiveBroadcast = function LiveBroadcast(param) {
            ...
            function set_latest() {
                ...
                JSON.stringify(layer_effects) != JSON.stringify(e) && (layer_effects = e, set_layer()), archive_manager.cameBackAt > self.clock.get_time_lapse_ms() && (self.idol_message.is_idol_hidden = !0), self.user_message_log.reset();
                ...
                ["idol", "idol_comment", "user_comment", "wall1", "wall2", "enquete", "enquete_result", "info_comment"].forEach(function(t) {
                    ...
                    switch (null != t.image_path && (t.category_name.match("wall") || t.category_name.match("enquete")) && (t.image_path.match("http") ? s.find(".wall_image").prop("src", t.image_path) : s.find(".wall_image").prop("src", image_url + t.image_path)), 3 == e && (0 == t.state ? ($("#layer_wall2").addClass("_show_layer").removeClass("_hide_layer"), $("#layer_user_comment").css("z-index", 4)) : ($("#layer_wall2").addClass("_hide_layer").removeClass("_show_layer"), $("#layer_user_comment").css("z-index", 0))), 0 == t.effectid ? s.hide() : s.show(), $("#main_area").append(s), t.category_name) {
                        case "idol":
                            ...
                            } else if (self.idol_message_log.isEmpty()) archive_manager.cameBackAt > self.clock.get_time_lapse_ms() ? (self.idol_message.is_idol_hidden = !0, self.idol_message.setEmotion(0, 91, 0)) : self.idol_message.setEmotion(0, 0, 0), self.idol_message.hideIdolMessage(0, !1);
                            else {
    ...
    var i = function() {
        ...
        return _createClass(e, [{
            ...
            value: function(e) {
                ...
                if (clearTimeout(this.hideMessageIntervalHandler), this.appearIdolMessage(t), this.current_expression_type = e.expression_type, this.current_motion_type = e.motion_type, 14 == this.live_bc_id ? this.balloon_direction = 0 : this.balloon_direction = 8 == this.current_expression_type ? 1 : 0, a && (this.balloon_direction = 2), s ? ("hidden" == this.mode && (this.is_idol_hidden ? (this.balloon_direction = 1, this.setEmotion(8, 0, 0)) : (l = 9 == this.current_expression_type ? 1 : this.current_expression_type, this.setEmotion(l, 0, 0))), "changed" == this.mode && (this.is_idol_changed ? this.setEmotion(0, 81, 0) : (l = 13 == this.current_expression_type ? 7 : this.current_expression_type, this.setEmotion(l, 0, 0))), this.mode || this.setEmotion(l, 0, 0)) : a || (this.is_idol_hidden ? this.setEmotion(0, 91, 0) : this.is_idol_changed ? this.setEmotion(0, 81, 0) : this.setEmotion(this.current_expression_type, this.current_motion_type, 0)), a ? this.msg_spd = this.guest_idol_message_speed : (this.msg_spd = this.idol_message_speed, this.setExpression(this.current_expression_type, this.current_motion_type, t, s)), void 0 != e.message) {
